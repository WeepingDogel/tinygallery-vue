...
export default {
  ...
  watch: {
    "logStatus.isLogged"(newValue, oldValue) {
      // Watch changes to the "isLogged" property of the store
  ...
  methods: {
    ...
    displayLogout() {
      // Show or hide the logout button based on whether the user is logged in or not
      if (this.logStatus.isLogged) {
...
<template>
  ...
  <!-- Render the uploader component and bind it to a model -->
</template>
